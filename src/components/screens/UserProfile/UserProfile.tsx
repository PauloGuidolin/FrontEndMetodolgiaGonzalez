        ...
        <>
            ...
            <div className={styles.main}>
                <div className={styles.profileContainer}>
                    <img
                        // user?.profileImage?.url es lo correcto.
                        // El fallback puedes ajustarlo si prefieres un ícono o una imagen local específica
                        src={user?.profileImage?.url || "https://via.placeholder.com/200x200?text=Usuario"} // Un placeholder genérico si no hay imagen
                        alt="Foto de perfil"
                        ...
                        onError={(e) => {
                            ...
                            target.onerror = null;
                            target.src =
                                "https://via.placeholder.com/200x200/FFFFFF/000000?text=Error"; // Fondo blanco, texto negro
                            console.error(
