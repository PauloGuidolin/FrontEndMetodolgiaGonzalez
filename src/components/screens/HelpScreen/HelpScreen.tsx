...
export const HelpScreen = () => {
  ...
  const toggleAnswer = (index: number) => {
    ...
    requestAnimationFrame(() => {
      ...
      answerElement.style.height = willOpen ? `${answerElement.scrollHeight}px` : '0';
      ...
      <div className={style.mainContent}>
        ...
        <div className={style.conteinerForQuestions}>
          <div className={style.conteinerQuestions1}>
            <div>
              <button onClick={() => toggleAnswer(0)}>¿Mi compra es segura?</button>
              <div ref={(el) => { answerRefs.current[0] = el; }} className={isOpen[0] ? style.open : ""}>
                <p>
                  Sí, utilizamos protocolos de seguridad avanzados para proteger tu
                  información de pago y personal.
                </p>
              </div>
            </div>
            <div>
              <button onClick={() => toggleAnswer(1)}>¿Hacemos envíos?</button>
              <div ref={(el) => { answerRefs.current[1] = el; }} className={isOpen[1] ? style.open : ""}>
                <p>
            ...
            <div>
              ...
              <div ref={(el) => { answerRefs.current[2] = el; }} className={isOpen[2] ? style.open : ""}>
                <p>
          ...
          <div className={style.conteinerQuestions2}>
            <div>
              <button onClick={() => toggleAnswer(3)}>¿Cual es el tiempo de entrega?</button>
              <div ref={(el) => { answerRefs.current[3] = el; }} className={isOpen[3] ? style.open : ""}>
                <p>
            ...
            <div>
              <button onClick={() => toggleAnswer(4)}>¿Tienen tiendas fisicas?</button>
              <div ref={(el) => { answerRefs.current[4] = el; }} className={isOpen[4] ? style.open : ""}>
                <p>
                  Si, podras encontra muchas de nuestas sucursales en todo el país.
                </p>
              </div>
            </div>
            <div>
              <button onClick={() => toggleAnswer(5)}>¿Tienen guia de talles?</button>
              <div ref={(el) => { answerRefs.current[5] = el; }} className={isOpen[5] ? style.open : ""}>
                <p>
          ...
          <div className={style.conteinerQuestions3}>
            <div>
              <button onClick={() => toggleAnswer(6)}>¿Como puedo rastrear mi pedido?</button>
              <div ref={(el) => { answerRefs.current[6] = el; }} className={isOpen[6] ? style.open : ""}>
                <p>
                  Puedes consultar el estado de tu pedido en cualquier momento en la pestaña de pedidos.
                </p>
              </div>
            </div>
            <div>
              <button onClick={() => toggleAnswer(7)}>¿Tienen tiendas fisicas?</button>
              <div ref={(el) => { answerRefs.current[7] = el; }} className={isOpen[7] ? style.open : ""}>
                <p>
                  Si, podras encontra muchas de nuestas sucursales en todo el país.
                </p>
              </div>
            ...
            <div>
              <button onClick={() => toggleAnswer(8)}>¿Como solicito una devolución?</button>
              <div ref={(el) => { answerRefs.current[8] = el; }} className={isOpen[8] ? style.open : ""}>
                <p>
                  Para realizar una devolución, debes enviar un correo electrónico a
                  nuestro equipo de atención al cliente, indicando el número de
                  pedido y la cantidad a devolver. y que la devolución cumpla con los
                  plazos de entrega establecidos por nuestro equipo.
                </p>
              </div>
            </div>
          </div>
