...
>>>>>>> e037844ad05ed662af8680b525b453b82766e95a
...
<<<<<<< HEAD
  const navigate = useNavigate(); // <-- Inicializar useNavigate // Función genérica para manejar la navegación con filtros // Define los tipos de filtros que puede recibir

  const handleFilterNavigation = (filters: {
    categorias?: string[];
    denominacion?: string;
  }) => {
    const params = new URLSearchParams(); // La categoría base para este dropdown es "Indumentaria"
        ...
        <div className={styles.containerInfo}>
          <div className={styles.containerTable}>
            <div className={styles.containerColumn1}>
              ...
              <p
                onClick={() =>
                  handleFilterNavigation({ categorias: ["Fútbol", "Botines"] })
                }
              ...
              <p
                onClick={() =>
                  handleFilterNavigation({ categorias: ["Fútbol"] })
                }
                className={styles.filterLink}
              >
                Selección Argentina
              ...
              <p
                onClick={() =>
                  handleFilterNavigation({ categorias: ["Fútbol", "Remera"] })
                }
                className={styles.filterLink}
              >
                Camisetas de Fútbol
            ...
            <div className={styles.containerColumn2}>
              ...
              <p
                onClick={() =>
                  handleFilterNavigation({ categorias: ["Tenis", "Calzados"] })
                }
                className={styles.filterLink}
              >
                Calzado
            ...
            <div className={styles.containerColumn3}>
              ...
              <p
                onClick={() =>
                  handleFilterNavigation({
                    categorias: ["Running", "Indumentaria"],
                  })
                }
                className={styles.filterLink}
              >
              ...
              <p
                onClick={() =>
                  handleFilterNavigation({ categorias: ["Running"] })
                }
                className={styles.filterLink}
              >
                Running
