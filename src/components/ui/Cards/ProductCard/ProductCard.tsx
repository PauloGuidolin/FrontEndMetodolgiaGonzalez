...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
    ...
    console.log("   descuento (ID):", product.descuento ? product.descuento.id : "N/A");
    console.log("   descuento (activo):", product.descuento ? product.descuento.activo : "N/A");
    console.log("   descuento (precioPromocional):", product.descuento ? product.descuento.precioPromocional : "N/A");
                ...
                <div className={styles.priceContainer}>
                    ...
                    <span className={styles.finalPrice}>
                        ${typeof product.precioFinal === 'number' && product.precioFinal !== null
                            ...
                            : (typeof product.precioOriginal === 'number' ? product.precioOriginal.toFixed(2) : '0.00')
                        }
                    </span>
                </div>
            </div>
