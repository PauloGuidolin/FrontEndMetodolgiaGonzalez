                ...
                <div className={styles.columnsContainer}>
                    ...
                    <div className={styles.column}>
                        ...
                        <ul>
                            ...
                            <li onClick={() => handleFilterNavigation({ categorias: ["Calzados"] })} className={styles.filterLink}>Calzados</li>
                            <li onClick={() => handleFilterNavigation({ categorias: ["Indumentaria"] })} className={styles.filterLink}>Indumentaria</li>
                            <li onClick={() => handleFilterNavigation({ categorias: ["Equipos"] })} className={styles.filterLink}>Equipos</li>
                        </ul>
                    </div>
