...
import { CategoriaDTO } from '../components/dto/CategoriaDTO'; // Importa CategoriaDTO para consistencia.
...
interface CategoryState {
    ...
    categories: CategoriaDTO[]; // Usar CategoriaDTO
    loading: boolean;
    error: string | null;

    // Estado para categorías raíz (sin padre)
    rootCategories: CategoriaDTO[]; // Usar CategoriaDTO
    loadingRoot: boolean;
    errorRoot: string | null;

    // Estado para subcategorías de una categoría padre
    subcategories: CategoriaDTO[]; // Usar CategoriaDTO
    ...
    addCategory: (categoryData: Partial<CategoriaDTO>) => Promise<CategoriaDTO>; // Usar CategoriaDTO
    updateCategory: (category: CategoriaDTO) => Promise<CategoriaDTO>; // Usar CategoriaDTO
    ...
    // selectedCategory: CategoriaDTO | null; // Usar CategoriaDTO
    // setSelectedCategory: (category: CategoriaDTO | null) => void;
}
...
export const useCategoryStore = create<CategoryState>((set, get) => ({
    ...
    addCategory: async (categoryData: Partial<CategoriaDTO>) => { // Usar CategoriaDTO
    ...
    updateCategory: async (category: CategoriaDTO) => { // Usar CategoriaDTO
    ...
    // setSelectedCategory: (category: CategoriaDTO | null) => set({ selectedCategory: category }),
}));