...
interface AddressState {
    ...
    addAddress: (addressData: Partial<DomicilioDTO>) => Promise<DomicilioDTO>; // <--- CAMBIADO

    // Acción para actualizar una dirección existente
    updateAddress: (address: DomicilioDTO) => Promise<DomicilioDTO>; // <--- CAMBIADO
    ...
    // selectedAddress: DomicilioDTO | null; // <--- CAMBIADO
    // setSelectedAddress: (address: DomicilioDTO | null) => void;
}
...
export const useAddressStore = create<AddressState>((set, get) => ({
    ...
    addAddress: async (addressData: Partial<DomicilioDTO>) => { // <--- CAMBIADO
    ...
    updateAddress: async (address: DomicilioDTO) => { // <--- CAMBIADO
    ...
    // setSelectedAddress: (address: DomicilioDTO | null) => set({ selectedAddress: address }), // <--- CAMBIADO
}));